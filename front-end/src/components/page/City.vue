    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i> 城市列表
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            ...
            >
                ...
                <el-table-column prop="PowerTariff" label="城市电价"></el-table-column>
                <el-table-column prop="NationName" label="所在国家" ></el-table-column>
                <el-table-column prop="Area" label="所处地区" ></el-table-column>
        ...
        <el-dialog :title='action + "城市"' :visible.sync="dialogFormVisible" width='40%'>
            <el-form :model="form" :label-position="'left'">
                ...
                <el-form-item label="城市电价" :label-width="formLabelWidth">
                <el-input v-model="form.PowerTariff" autocomplete="off" size="small"></el-input>
                </el-form-item>
...
export default {
    ...
    methods: {
        ...
        submitHost() {
            request.put('/api/city',
                        {'CityName': this.form.CityName,
                         'PowerTariff': this.form.PowerTariff, 
                         'NationName': this.selectValue,
